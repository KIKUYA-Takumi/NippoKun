...
urlpatterns = [
    ...
    url(r'^(?P<pk>[0-9]+)/score/edition/$', login_required(UpdateScore.as_view()), name='update_score'),
    url(r'^(?P<pk>[0-9]+)/score/delete/$', login_required(DeleteScore.as_view()), name='delete_score'),
]
